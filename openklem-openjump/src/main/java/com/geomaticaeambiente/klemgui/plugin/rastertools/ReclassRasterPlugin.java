...
public class ReclassRasterPlugin extends AbstractInputKlemPlugin {
    ...
    public InitialData setInitialData() {
        ...
        initialData.setParam_Label_TextBox(
                GUIUtils.setGUILabel(INTERVAL_LABEL), "", GUIUtils.INPUT);//interval  
    ...
    public ComponentsTreeMap setComponentsActions(
        ...
        final JButton jButton_findValue = (JButton) personalTreeMap
                .getComponent("01", GUIUtils.INPUT, 2); //Find values button  // 01 input= row   2=column

        final CustomComboBox.RasterComboBox raster = (CustomComboBox.RasterComboBox) (JComboBox) personalTreeMap
                .getComponent("00", GUIUtils.INPUT, 1);//raster in combobox action
        ...
        final PersonalTableComponents personalComp_Table = (PersonalTableComponents) personalTreeMap
