...
public class FlowDirectionPlugIn extends AbstractInputKlemPlugin {
    ...
    public void flowDirectionCommand(
        ...
        final FlowDirsCalculator flowDireCalculator = new FlowDirsCalculator(
                inputGrid, FlowDirsStripe.FlowDirAlgorithm.D8, bluelines, 100d);
        final FlowDirBasicGrid flowDirByteGrid = flowDireCalculator.calculate();
    ...
    private final String RASTER_IN_LABEL = PluginUtils.i18n("KlemGUI.InputFilledDem.label");
    private final String RASTER_FLOWDIRS = PluginUtils.i18n("FlowDirectionPlugin.PlugInName.label");
